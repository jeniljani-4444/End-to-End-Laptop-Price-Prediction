...
pros_gen = st.selectbox("Processor Genereation",laptop['pros_gen'].unique())
...
graphic_card = st.selectbox("Graphic Card",laptop['graphic_card'].unique())
...
if st.button("Predict Price"):
    ...
    st.title("The predicted price of this configuration is " + str(int(np.exp(pipe.predict(final_pred)[0]))))
