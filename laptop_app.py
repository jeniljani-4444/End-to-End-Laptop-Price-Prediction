...
#         st.title(f"The predicted price of laptop is: {predicted_price}")
...
#     avg_line_cols_prices = laptop.groupby(by=[line_cols]).mean()['price']
#     # Create a Line Chart
#     fig = px.line(avg_line_cols_prices, x=avg_line_cols_prices.index,
...
#     input_donut_chart = st.multiselect("Select options for Donut Chart:", [
